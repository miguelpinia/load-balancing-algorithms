 ...
 * @author miguel
 */
public class StepFIFOWorkStealingV1 implements StepSpanningTree {
    ...
    private final FIFOWorkStealingV1 fifo;
    private final FIFOWorkStealingV1[] fifos;
    private final Random random;

    public StepFIFOWorkStealingV1(Graph graph, int root, int[] color, int[] parent,
            int label, FIFOWorkStealingV1 fifo, FIFOWorkStealingV1[] fifos,
