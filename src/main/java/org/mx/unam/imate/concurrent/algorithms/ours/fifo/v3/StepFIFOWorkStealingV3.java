 ...
 * @author miguel
 */
public class StepFIFOWorkStealingV3 implements StepSpanningTree {
    ...
    private final FIFOWorkStealingV3 fifo;
    private final FIFOWorkStealingV3[] fifos;
    private final Random random;

    public StepFIFOWorkStealingV3(Graph graph, int root, int[] color, int[] parent,
            int label, FIFOWorkStealingV3 fifo, FIFOWorkStealingV3[] fifos,
